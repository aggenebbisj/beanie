...
public class RecipeResourceIT {
    ...
    @Test
    public void test() {
        final WebTarget target = client.target("http://localhost:8080/eelco/resources/brewer");
        final JsonObject recipe = aRecipeJson();
        Response changeTemperatureResponse = target.path("recipe").request().post(Entity.entity(recipe,
